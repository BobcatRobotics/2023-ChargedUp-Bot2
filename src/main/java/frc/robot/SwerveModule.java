...
public class SwerveModule {
    ...
    /**
     * Makes angle positive from [0, 360]
     * @param anAngle - angle to make positive within bounds
     * @return double -  positive angle from [0, 360] representing the same angle passed in
     */
    ...
    /**
     * feeder function to make angle positive and within [0, 360]
     * @param anAngle - rotation2d of angle
     * @return double - positive angle from [0, 360] representing the same angle passed in
     */
    ...
    /**
     * optimize turn custom function between two angles
     * @param oldAngle - Rotation2d; current angle
     * @param newAngle - Rotation2d; angle to turn to
     * @return
     */
